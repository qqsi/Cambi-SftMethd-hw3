...
public class NGram extends Annotation {
  ...
  //*--------------*
  //* Feature: numberOfGrams

  /** getter for numberOfGrams - gets 
   * @generated */
  public int getNumberOfGrams() {
    if (NGram_Type.featOkTst && ((NGram_Type)jcasType).casFeat_numberOfGrams == null)
      jcasType.jcas.throwFeatMissing("numberOfGrams", "edu.cmu.deiis.types.NGram");
    return jcasType.ll_cas.ll_getIntValue(addr, ((NGram_Type)jcasType).casFeatCode_numberOfGrams);}
    
  /** setter for numberOfGrams - sets  
   * @generated */
  public void setNumberOfGrams(int v) {
    if (NGram_Type.featOkTst && ((NGram_Type)jcasType).casFeat_numberOfGrams == null)
      jcasType.jcas.throwFeatMissing("numberOfGrams", "edu.cmu.deiis.types.NGram");
    jcasType.ll_cas.ll_setIntValue(addr, ((NGram_Type)jcasType).casFeatCode_numberOfGrams, v);}    
  }
