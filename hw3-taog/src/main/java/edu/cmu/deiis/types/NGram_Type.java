...
public class NGram_Type extends Annotation_Type {
  ...
  /** @generated */
  final Feature casFeat_numberOfGrams;
  /** @generated */
  final int     casFeatCode_numberOfGrams;
  /** @generated */ 
  public int getNumberOfGrams(int addr) {
        if (featOkTst && casFeat_numberOfGrams == null)
      jcas.throwFeatMissing("numberOfGrams", "edu.cmu.deiis.types.NGram");
    return ll_cas.ll_getIntValue(addr, casFeatCode_numberOfGrams);
  }
  /** @generated */    
  public void setNumberOfGrams(int addr, int v) {
        if (featOkTst && casFeat_numberOfGrams == null)
      jcas.throwFeatMissing("numberOfGrams", "edu.cmu.deiis.types.NGram");
    ll_cas.ll_setIntValue(addr, casFeatCode_numberOfGrams, v);}
  ...
  public NGram_Type(JCas jcas, Type casType) {
    ...
    casFeat_numberOfGrams = jcas.getRequiredFeatureDE(casType, "numberOfGrams", "uima.cas.Integer", featOkTst);
    casFeatCode_numberOfGrams  = (null == casFeat_numberOfGrams) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_numberOfGrams).getCode();
